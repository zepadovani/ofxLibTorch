...
common:
    ...
    # @echo "Debug: Entering common section"
...
#     # LIBRARIES := -L$(LIBTORCH)/lib -ltorch -ltorch_cpu -lc10 -Wl,-rpath,$(LIBTORCH)/lib
#     # INCLUDE := -I/home/padovani/data/libtorch/include -I/home/padovani/data/libtorch/include/torch/csrc/api/include

# # Libraries
#     # LIBRARIES := -L/home/padovani/data/libtorch/lib -ltorch -ltorch_cpu -lc10 -Wl,-rpath,/home/padovani/data/libtorch/lib
#     ADDON_INCLUDES =
#     ADDON_INCLUDES += src
